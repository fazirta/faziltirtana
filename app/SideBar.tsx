...
const SideBar = () => {
  ...
  return (
    <div
      className={`fixed z-50 m-0 flex h-full w-20 flex-col bg-white/10 backdrop-blur-md py-2 shadow-lg transition-all duration-300 ease-in-out  dark:bg-white/10 dark:text-white  sm:top-2/4 sm:h-[500px] sm:max-h-[80%] sm:-translate-y-2/4  sm:rounded-2xl ${!isOnLeft
