...
const BottomNav = () => {
  ...
  return (
    <div
      className="flex z-10 fixed bottom-0 rounded-t-3xl h-[4.5rem] w-full items-center justify-evenly bg-white/10 shadow-lg backdrop-blur-md dark:bg-white/10 dark:text-white
        ">
      <Link href="/">
        <a className="h-full">
          <SideBarIcon
